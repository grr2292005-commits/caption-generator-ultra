...
> **Local AI Text-Based Editing and Caption Generation Extension Suite for Adobe Premiere Pro & After Effects**

Caption Generator ULTRA is an Adobe CEP extension suite that brings local offline AI transcription, interactive text-based video editing, silent pause removal, filler word removal, and synchronized caption generation directly to your Adobe timeline.
...
- **Local Offline Speech AI**:
  ...
  - Sequence & Composition media extraction via bundled local FFmpeg runtime with zero cloud dependencies or recurring API costs.

- **Flexible Transcription Scope (Premiere Pro)**:
...
- **Text-Based Sequence Ripple Cutting (Premiere Pro)**:
...
- **After Effects Subtitles & Animation Presets**:
  - Direct subtitle layer creation in active comp or pre-comp.
  - Text animation presets (`.ffx` and built-in animations) with automatic keyframe duration fitting.
  - One-click vertical and horizontal layout alignment.
...
- **Interactive Transcript Tools**:
  ...
  - **Interactive Playhead Navigation**: Click any word to jump timeline playhead directly to that moment.
