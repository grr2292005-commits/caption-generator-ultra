@echo off
TITLE Caption Generator Pro (After Effects) - Installer

cd /d "%~dp0"

color 0B
echo ================================================================
echo     CAPTION GENERATOR PRO (AFTER EFFECTS) - INSTALLER
echo ================================================================
echo.
echo Installing After Effects extension into user AppData...
echo.

set "USER_CEP_DIR=%APPDATA%\Adobe\CEP\extensions\CaptionGeneratorProAE"
...
echo.
echo ================================================================
echo SUCCESS! After Effects Extension installed to AppData.
echo ================================================================
echo.
echo Instructions:
echo 1. Fully quit Adobe After Effects (check Task Manager)
echo 2. Launch Adobe After Effects
echo 3. Open Window -^> Extensions -^> Caption Generator Pro (AE)
echo.
pause
